...
*/
bool Character::operator== (const Character& another_character) const
{
    if((name_ == another_character.name_) && (race_ == another_character.race_) && (level_ == another_character.level_) && (enemy_ == another_character.enemy_)){
        return true;                    //return true if the character are equal in name, race, level and if one is an enemy or not
    }
    else{
        return false;                   //return false if the character are not equal in one of the name, race, level, or if one is an enemy or not
    }
}
...
/**
    ...
    Note: By this definition, one or more of the aforementioned subset of the character's attributes only must be different for two characters to be deemed "NOT equal".
*/
bool Character::operator!= (const Character& another_character) const
{
    if((name_ == another_character.name_) && (race_ == another_character.race_) && (level_ == another_character.level_) && (enemy_ == another_character.enemy_)){
        return false;               //return false if the character are equal in name, race, level and if one is an enemy or not
    }
    else{
        return true;                //return true if the character are not equal in one of the name, race, level, or if one is an enemy or not
    }
}
...
{
    std::string if_enemy = (enemy_) ? "They are " : "They are not ";
